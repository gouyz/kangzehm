...
class KZTransformManagerVC: GYZBaseVC {

    let titleArr : [String] = ["积分","库存"]
    let typeValue : [String] = ["1","2"]
    ...
    override func viewDidLoad() {
        ...
        rightBtn.setTitle("明细", for: .normal)
    ...
    func setChildVcs() -> [UIViewController] {
        ...
        var childVC : [KZTransformVC] = []
        for index in 0 ..< titleArr.count{
            
            let vc = KZTransformVC()
            vc.typeValue = typeValue[index]
            childVC.append(vc)
        }
